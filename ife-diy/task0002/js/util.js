...
function simpleTrim(str) {
    var i;
    var j;
    for (i = 0; i < str.length; i++) {//遍历
        if (str.charAt(i)!=" "&&str.charAt(i)!="\t") {//当不为空时跳出循环
            break;
        }
    }
...
// console.log(isEmail("111111@1222.conm"));
// console.log(isEmail("ssss.sss"));
// ------------------------------------------------------------------
// 判断IE版本号，返回-1或者版本号
// ------------------------------------------------------------------
